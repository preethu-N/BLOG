...
const Home = ({ isLoggedIn, posts = defaultPosts }) => {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex gap-4 items-center">
            ...
            {isLoggedIn && (
              <Link
                to="/create-post"
                className="bg-[#5850ec] hover:bg-indigo-700 text-white px-5 py-2 rounded-lg font-medium transition cursor-pointer"
              >
                Write a Post
              </Link>
            )}
            ...
            <input
              ...
              className="w-[350px] border rounded-lg px-4 py-2 outline-none"
            />
          </div>

          <p className="text-gray-500">{gridPosts.length} Posts</p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-2 border rounded-2xl overflow-hidden">
          ...
          <div className="p-10 flex flex-col justify-center">
            ...
            <div className="flex items-center justify-between mt-10">
              <div>
                <h4 className="font-semibold">{featuredPost.author}</h4>
